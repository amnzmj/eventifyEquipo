        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('events.create') ? 'active' : '' }}" href="{{ route('events.create') }}">Crear Evento</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('my.purchases') ? 'active' : '' }}" href="{{ route('my.purchases') }}">Mis Compras</a>
                        </li>
